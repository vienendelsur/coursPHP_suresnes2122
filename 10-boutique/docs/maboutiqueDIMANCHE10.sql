...
--
-- Hôte : localhost:8889
-- Généré le :  Dim 10 avr. 2022 à 07:57
...
CREATE TABLE `membres` (
  ...
  `statut` int(1) NOT NULL DEFAULT '0' COMMENT '1 = administrateur, 0 = client'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'pisola10', '$2y$10$VXjHvmILQNUmO0N74AOl0ecnGfATCOzHFpGTitCnQeyOgvOBbY/ye', 'Isola', 'Patrick', 'isola.patrick@gmail.com', 'm', 'Paris', 75019, '16, avenue de Laumière', 1),
(7, 'bébé', '$2y$10$xO1AiZD4soKPmJa304vRtuxpXU7vAMS4fBn6i.5sPsUqaV1.32OJ.', 'Ouahmane', 'Emilie', 'isola.patrick@gmail.com', 'f', 'Paris', 56231, 'rue de la joie', 0);
